...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email === '' || $password === '') {
        ...
        $stmt = mysqli_prepare($conn, 'SELECT visitor_id, full_name, email, password FROM visitor WHERE email = ? LIMIT 1');
        ...
        if ($visitor && $visitor['password'] === $password) {
            $_SESSION['visitor_id'] = $visitor['visitor_id'];
...
<head>
  ...
  <title>Darbic - Visitor Login</title>
  ...
  <section class="login-wrapper">
    <div class="login-card">
      ...
      <p class="login-subtitle">
        Log in securely to access your visitor dashboard.
      </p>
      ...
      <form action="" method="post">
        ...
        <div class="extra-links">
          ...
          <a href="visitor-signup.php">Sign Up</a>
        </div>
